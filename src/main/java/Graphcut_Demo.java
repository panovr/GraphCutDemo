...
public class Graphcut_Demo implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		no_graphcut = NewImage.createRGBImage("Direct composite", cwidth,
				cheight, 1, NewImage.FILL_BLACK);
		...
		for (int y = 0; y < height; y++) {
			...
			g.setTerminalWeights(y * overlap_width + overlap_width - 1, 0,
					Integer.MAX_VALUE);
		}
	...
	public static void main(String[] args) {
		...
		ImagePlus image = IJ
				.openImage("http://cs2.swfc.edu.cn/~zyl/wp-content/uploads/2015/05/strawberry.jpg");
		image.show();
